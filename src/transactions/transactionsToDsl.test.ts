...
describe('transactionsToDsl', () => {
  ...
  it.each(['0=', '00=', '000=', '0000=', '00000=', '00000000='])(
    'truncates trailing %s filler data before parsing transaction recipients',
    (filler) => {
      const path = parseTransactionDslPath(`/Building/Floor/Room/+0+2/+0+1/+4+3${filler}`);
