...
/** Canonical editor input for the primary key, observed on the shared secondary node. */
export interface PrimarySceneInput extends TransactionPublicKeyEndpoint {
  transactions: XyzDslTransaction[];
  realtimeStatus: SecondaryRealtimeStatus;
  streamError?: string;
  historyLoading?: boolean;
