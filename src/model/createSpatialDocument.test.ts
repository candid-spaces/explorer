...
"Table/Leg/" : "geometry: cylinder"
"Table/FrontLeft/+0+1/+0+5/+0+1" : "geometry: cylinder"
"Table/BackRight/+7+1/+0+5/+7+1" : "geometry: cylinder"`);
...
"Table/Leg/" : "geometry: cylinder"
"Table/Leg/Red/+0+1/+0+1/+0+1" : "color: red"
"Table/Leg/Grey/+2+1/+0+1/+0+1" : ""`);
...
"Table/Leg/" : "geometry: cylinder"
"Table/FrontLeft/+0+1/+0+5/+0+1" : "geometry: cylinder"
"Table/FrontRight/+7+1/+0+5/+0+1" : "geometry: cylinder"
"Table/BackLeft/+0+1/+0+5/+7+1" : "geometry: cylinder"
"Table/BackRight/+7+1/+0+5/+7+1" : "geometry: cylinder"
"+19+4/+0+6/+7+3" : "ref: Table/"`);
    ...
    const firstLeg = document.renderNodes.find(
      (node) =>
        node.namespacePath?.endsWith('/FrontLeft/') &&
    ...
    expect(firstLeg?.namespacePath).toBe('Ref6/FrontLeft/');
...
"+19+4/+0+6/+7+3" : "ref: Table/"`);
    ...
    const firstLeg = document.renderNodes.find(
      (node) =>
        node.namespacePath === 'Ref8/FrontLeft/' &&
        node.box.source === '+0+1/+0+5/+0+1',
    );
